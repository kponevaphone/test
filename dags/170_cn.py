...
with DAG(
  ...
  second_task = KubernetesPodOperator(
    ...
    container_resources=k8s.V1ResourceRequirements(limits={"nvidia.com/gpu": "all"},),
    tolerations = [k8s.V1Toleration(key="nvidia.com/gpu", operator="Equal", value="all", effect="NoSchedule")],
